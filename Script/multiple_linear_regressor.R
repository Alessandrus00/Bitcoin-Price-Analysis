...
#verifica della correlazione dei predittori con la risposta
ggpairs(btc)
...
#creazione del modello con caret
model<- train(Close~High+Low+Volume+Open, data=btc.training, method="lm", trControl=fitControl)
...
plot(predictions,resid, col="blue1", main="MLR: Dispersione delle predizioni",ylim=c(-6000,6000),xlab="Valori Predetti", ylab="Residui")
abline(0,0, col="red")
